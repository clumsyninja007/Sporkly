...
@LargeTest
public class myShoppingListActivityTest {
    private String testQuery;

    @Rule
    public ActivityTestRule<myShoppingListActivity> mActivityRule = new ActivityTestRule<>(
            myShoppingListActivity.class);
    ...
    public void query() {
        // Edit the text box
        onView(withId(R.id.shoppingEditText))
        ...
        onView(withId(R.id.shoppingSearchList))
